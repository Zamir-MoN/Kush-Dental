    ...
    <section ref={sectionRef} className="py-20 sm:py-28 lg:py-32 px-4 sm:px-6 lg:px-12 bg-white overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14 lg:mb-20">
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-zinc-900 leading-tight mb-3 tracking-tight reveal-up">
                ...
                <div className={`lg:col-span-6 ${isEven ? 'lg:pl-10 order-2' : 'lg:pr-10 order-2 lg:order-1'}`}>
                  ...
                  <div className="relative z-10 -mt-6 lg:-mt-8">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 rounded-xl bg-[#FAF7F2] border border-[#E8E2D5] text-[#DCA51B] flex items-center justify-center shrink-0">
                        <ServiceIcon className="w-5 h-5" />
                      </div>
                      <h3 className="font-serif font-bold text-2xl sm:text-3xl lg:text-4xl text-zinc-900 leading-tight">
                        {service.title}
                      </h3>
                    </div>
                    
                    <p className="text-zinc-600 text-sm sm:text-base leading-relaxed mb-5 font-sans font-light">
                      {service.description}
                    </p>
