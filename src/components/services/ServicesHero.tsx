...
export const ServicesHero = () => {
  ...
  return (
    <section ref={sectionRef} className="max-w-container mx-auto px-margin-mobile md:px-margin-tablet lg:px-margin-desktop pt-24 sm:pt-28 pb-12 sm:pb-16 flex flex-col lg:flex-row items-center gap-10 lg:gap-16 scroll-mt-24">
      {/* Text Column */}
      <div className="flex-1 space-y-6 reveal-up">
        <h1 className="font-display text-on-surface tracking-tight text-4xl sm:text-5xl lg:text-6xl leading-[1.1] text-tertiary">
          Complete Dental Care <br/>
          <span className="text-secondary italic font-light">Under One Roof</span>
        </h1>
        <p className="text-neutral text-base sm:text-lg max-w-2xl leading-relaxed">
        ...
        <div className="pt-4 flex flex-wrap gap-4">
          <Link to="/book" className="btn-gold-luxury px-8 py-3.5 text-xs">
            Schedule Consultation
          </Link>
          <button className="border border-border/50 text-tertiary font-display font-medium px-8 py-3.5 rounded-3xl hover:bg-white/50 transition-colors cursor-hover bg-transparent">
            View Price List
          </button>
        </div>
      </div>
      ...
      {/* Image Column */}
      <div className="flex-1 w-full h-[320px] sm:h-[400px] lg:h-[480px] rounded-[2.5rem] overflow-hidden relative shadow-xl reveal-up">
        <img 
