...
export const InteractiveClinicMap: React.FC = () => {
  return (
    <div className="relative w-full h-[460px] lg:h-full min-h-[460px] rounded-3xl overflow-hidden shadow-xl border border-border/40 flex flex-col bg-[#f0ede6]">
      ...
      <div className="relative w-full flex-grow min-h-[300px] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 z-10 bg-white/95 backdrop-blur-md px-3.5 py-2 rounded-2xl shadow-lg border border-white/80 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-neutral">Medical Arcade • Suite 402</p>
          </div>
        </div>
      </div>

      {/* Clean Bottom Info & Directions Bar */}
      <div className="bg-white p-5 border-t border-border/30 flex flex-col gap-3">
        <div className="flex justify-between items-center">
          <div>
            <h4 className="font-display font-bold text-base text-tertiary">Kush Dental Clinic & Aesthetics</h4>
        ...
        <div className="grid grid-cols-2 gap-2 text-xs border-t border-border/30 pt-3 text-neutral">
        ...
        <a 
          ...
          className="mt-1 w-full bg-secondary text-primary font-bold text-xs uppercase tracking-wider py-3 rounded-xl flex items-center justify-center gap-2 hover:bg-[#c49216] transition-all duration-300 shadow-sm active:scale-[0.98]"
        >
