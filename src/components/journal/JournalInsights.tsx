      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-end mb-8 sm:mb-10 lg:mb-12">
          <div className="lg:col-span-8 reveal-up">
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-[44px] xl:text-5xl text-zinc-900 leading-[1.12] tracking-tight">
              Journal &amp; Insights<span className="text-[#DCA51B]">.</span>
            </h2>
          </div>

          <div className="lg:col-span-4 flex flex-col justify-end lg:pb-1 reveal-up">
            <p className="text-zinc-600 text-xs sm:text-sm lg:text-[15px] font-sans font-light leading-relaxed border-l-2 border-[#DCA51B]/60 pl-4 sm:pl-5 mb-3">
        ...
        {showFilters && (
          <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto pb-4 mb-8 sm:mb-10 no-scrollbar reveal-up">
            {categories.map((cat) => {
              ...
              <div className="bg-white rounded-3xl border border-[#E8E2D5] hover:border-[#DCA51B]/50 shadow-lg hover:shadow-xl transition-all duration-400 overflow-hidden group reveal-up">
                <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch">
                  ...
                  <div className="lg:col-span-7 relative h-[220px] sm:h-[280px] lg:h-auto min-h-[240px] lg:min-h-[280px] overflow-hidden bg-[#141518]">
                    ...
                    {/* Bottom Metadata */}
                    <div className="absolute bottom-4 left-4 right-4 text-white/90 flex items-center justify-between text-xs font-sans">
                  ...
                  <div className="lg:col-span-5 p-5 sm:p-7 lg:p-8 flex flex-col justify-between">
                    <div>
                      <div className="inline-flex items-center gap-2 text-[#DCA51B] text-[10.5px] font-bold uppercase tracking-[0.2em] font-sans mb-2">
                    ...
                    <div className="pt-4 border-t border-[#E8E2D5] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div className="flex items-center gap-2.5">
                        <img 
                          ...
                          loading="lazy"
                          decoding="async"
                          className="w-9 h-9 rounded-full object-cover border border-[#DCA51B]/40 shadow-xs"
                        />
                        <div>
                      ...
                      <Link 
                        to={`/blog/${leadPost.id}`}
                        className="btn-gold-luxury group/btn py-2 px-4 text-xs font-bold tracking-wider inline-flex items-center justify-center shrink-0"
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                {secondaryPosts.map((post) => (
                  <Link
                    key={post.id}
                    to={`/blog/${post.id}`}
                    className="bg-white rounded-3xl border border-[#E8E2D5] hover:border-[#DCA51B]/60 p-5 sm:p-6 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group cursor-pointer reveal-up"
                  >
                    <div>
                      {/* Card Image */}
                      <div className="relative w-full h-[150px] sm:h-[170px] rounded-2xl overflow-hidden mb-4 bg-[#141518]">
                        <img 
                          src={post.image} 
                          alt={post.title} 
                          loading="lazy"
