...
export const Hero: React.FC = () => {
  return (
    <section className="relative w-full pt-20 sm:pt-22 md:pt-24 lg:pt-0 min-h-[490px] sm:min-h-[530px] md:min-h-[580px] lg:h-[calc(100vh)] lg:min-h-[660px] lg:max-h-[920px] 2xl:max-h-[1020px] bg-[#141518] overflow-hidden flex flex-col justify-start lg:justify-center">
      ...
      {/* 2. Doctor Visual on Right (Tastefully proportioned, fully fitted without cutoff) */}
      <motion.div 
        initial={{ opacity: 0, y: 15 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.42, ease: [0.16, 1, 0.3, 1] }}
        className="flex absolute right-0 sm:right-2 md:right-4 lg:right-8 xl:right-14 bottom-0 z-20 pointer-events-none w-[44%] sm:w-[40%] md:w-[36%] lg:w-[35%] xl:w-[33%] max-w-[210px] sm:max-w-[280px] md:max-w-[340px] lg:max-w-[420px] xl:max-w-[460px] 2xl:max-w-[500px] h-[64%] sm:h-[70%] md:h-[76%] lg:h-[80%] max-h-[640px] items-end justify-end"
      >
        <img 
          ...
          className="max-h-full max-w-full w-auto h-full object-contain object-bottom object-right-bottom filter drop-shadow-[0_12px_28px_rgba(0,0,0,0.4)] select-none"
        />
        ...
        >
          ...
          <div className="pr-1">
            <div className="flex items-center gap-1">
              <p className="text-xs font-bold text-white font-serif drop-shadow-sm">Dr. Alexander Kush</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="w-[55%] sm:w-[56%] md:w-[58%] lg:w-full lg:col-span-7 xl:col-span-7 flex flex-col justify-center">
            ...
            >
              ...
              {/* Bold, Grand Headline */}
              <h1 className="font-serif text-[28px] sm:text-5xl lg:text-[54px] xl:text-[66px] 2xl:text-[76px] leading-[1.08] sm:leading-[1.06] text-white tracking-tight mb-2 sm:mb-3.5">
                Excellence<br />
                in Every<br />
              ...
              {/* Clear Subtitle */}
              <p className="text-zinc-200 font-sans font-light text-[11px] sm:text-base lg:text-[16px] leading-snug sm:leading-relaxed mb-3 sm:mb-5 max-w-[215px] sm:max-w-xl">
              ...
              <div className="inline-flex items-center gap-1 sm:gap-2.5 py-1 sm:py-1.5 px-2 sm:px-3.5 rounded-full bg-white/[0.06] border border-white/12 backdrop-blur-md mb-3 sm:mb-5">
            ...
            <motion.div 
              ...
              className="pt-1 sm:pt-2 w-full max-w-[215px] sm:max-w-xl"
            >
