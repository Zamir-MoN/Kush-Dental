  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto pb-12">
      <button
        ...
        className="group flex items-center text-xs sm:text-sm font-semibold text-zinc-500 hover:text-zinc-900 transition-colors cursor-pointer"
      >
      ...
      {successMsg && (
        <div className="bg-emerald-50 text-emerald-700 p-3.5 sm:p-4 rounded-xl flex items-center border border-emerald-200 text-xs sm:text-sm shadow-2xs">
          <CheckCircle2 className="w-5 h-5 mr-2 text-emerald-600 animate-bounce" />
          {successMsg}
        </div>
      )}

      {error && contact && (
        <div className="bg-red-50 text-red-600 p-3.5 sm:p-4 rounded-xl flex items-center border border-red-200 text-xs sm:text-sm shadow-2xs">
      ...
      <div className="bg-white shadow-xs rounded-2xl border border-[#E8E2D5] overflow-hidden">
        ...
        <div className="p-4 sm:p-6 bg-gradient-to-r from-[#FAF3E0]/50 to-transparent border-b border-[#E8E2D5]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="h-12 w-12 sm:h-16 sm:w-16 bg-gradient-to-br from-[#E5B22D] to-[#B8871B] rounded-2xl flex items-center justify-center text-[#141518] text-xl sm:text-2xl font-bold shadow-xs">
              ...
              <div>
                ...
                <div className="mt-0.5 sm:mt-1 flex space-x-6 text-xs sm:text-sm text-zinc-500">
                  <a href={`tel:${contact?.patient?.phone}`} className="group flex items-center hover:text-[#8C6B14] transition-colors">
                    <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 text-zinc-400 group-hover:text-[#DCA51B] transition-colors" />
            ...
            {user?.role === 'DOCTOR' && (
              <div>
                <button
                  ...
                  disabled={isDeleting}
                  className="flex items-center px-3.5 sm:px-4 py-2 text-xs font-bold uppercase tracking-wider text-rose-600 bg-rose-50 hover:bg-rose-100 rounded-xl transition-all border border-rose-200 disabled:opacity-50 cursor-pointer active:scale-95"
                >
        ...
        <div className="p-4 sm:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="space-y-4 sm:space-y-5">
              <h3 className="text-sm sm:text-base font-bold text-zinc-900 border-b border-[#E8E2D5] pb-2">Follow-up Details</h3>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-[#FAF7F2] border border-[#E2DACB] rounded-xl text-xs sm:text-sm text-zinc-900 focus:ring-2 focus:ring-[#DCA51B]/30 focus:border-[#DCA51B] disabled:bg-zinc-100 disabled:text-zinc-500 transition-all cursor-pointer font-medium"
                >
              ...
              <div className="pt-2">
                <button
                  onClick={handleSave}
                  disabled={isSaving}
                  className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-gradient-to-r from-[#E5B22D] via-[#DCA51B] to-[#C49216] text-[#141518] font-bold rounded-xl shadow-xs hover:shadow-md transition-all disabled:opacity-50 active:scale-95 cursor-pointer"
                >
                  {isSaving ? <Loader2 className="w-4 h-4 animate-spin mr-1" /> : (
                    <CheckCircle2 size={16} className="transition-transform duration-300 group-hover:scale-125" />
                  )}
            ...
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-sm sm:text-base font-bold text-zinc-900 border-b border-[#E8E2D5] pb-2">Related Information</h3>
              
              {contact?.lead && (
                <div className="bg-[#FAF7F2] p-4 rounded-xl border border-[#E2DACB] group">
                  <h4 className="text-xs font-bold text-zinc-700 uppercase tracking-wider mb-2 flex items-center">
                    <FileText className="w-4 h-4 mr-1.5 text-[#DCA51B] transition-transform group-hover:scale-110" /> Initial Lead Enquiry
                  </h4>
              ...
              {contact?.appointment && (
                <div className="bg-[#FAF7F2] p-4 rounded-xl border border-[#E2DACB] group">
                  <h4 className="text-xs font-bold text-zinc-700 uppercase tracking-wider mb-2 flex items-center">
                    <Calendar className="w-4 h-4 mr-1.5 text-[#DCA51B] anim-icon-pulse" /> Related Appointment
                  </h4>
                  <dl className="space-y-2 text-xs sm:text-sm">
                    <div className="flex justify-between">
                      <dt className="text-zinc-500">Status</dt>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <dd className="font-bold text-[#8C6B14] flex items-center bg-[#FAF3E0] border border-[#DCA51B]/30 px-2.5 py-1 rounded-lg text-xs">
                        <Clock className="w-3.5 h-3.5 mr-1 text-[#DCA51B] anim-icon-float" />
