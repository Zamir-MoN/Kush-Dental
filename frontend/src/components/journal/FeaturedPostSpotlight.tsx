            ...
            <div className="pt-6 border-t border-[#E8E2D5] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="font-serif font-bold text-sm text-[#141518] truncate">{post.author || 'Doctor'}</p>
                  <p className="font-sans text-xs text-zinc-500 truncate">{post.authorRole || 'Clinic'}</p>
                </div>
              </div>
